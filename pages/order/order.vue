        ...
        >
          ...
          >
            ...
            <view
              ...
              @tap.stop="
                navTo(`/pages/product/product?id=${goodsItem.product_id}`)
              "
              v-for="(goodsItem, goodsIndex) in item.product"
              :key="goodsIndex"
            >
              ...
              <view class="right">
                ...
                <text class="attr-box"
                  >{{ goodsItem.sku_name || "基础版" }} *
                  {{ goodsItem.num }}</text
                >
                <text
                  v-if="
                    goodsItem.point_exchange_type == 2 ||
                    goodsItem.point_exchange_type == 4
                  "
                >
